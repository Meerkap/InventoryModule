...
public class PageCalculator {
    public static List<Object> getPage(List<ItemStack> allItems, int page, int itemsPerPage) {
        List<Object> itemsActivos = allItems.stream().filter(item -> item != null).collect(Collectors.toList());
